...
```bash
$ docker pull ghcr.io/maplibre/martin:1.12.1 --platform linux/arm64
...
$ docker tag ghcr.io/maplibre/martin:1.12.1 493749042871.dkr.ecr.us-east-2.amazonaws.com/martin:latest
